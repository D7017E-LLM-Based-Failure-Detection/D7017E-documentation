...
- 2026-09-25 — G2 — Recorded that a sprint planning meeting had taken place. This is the reporting date; the meeting date and attendees are not yet confirmed.
...
- 2026-09-22 — G2 — Added a local MAESTRO handbook covering Turtle, ontology vocabulary, GraphDB, queries, system modelling, runtime data, reasoning and future API/RAG integration; linked it from the llm-kg README. These changes were still uncommitted when reviewed on 2026-09-25. → [G2 current state](groups/g2-llm-knowledge-graph/README.md#current-state)
...
- 2026-09-21 — G1 — Worked with G2 on the project description and completed it.
- 2026-09-21 — G2 — Worked with G1 on the project description and completed it.
